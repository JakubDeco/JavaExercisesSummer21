...
class ExerciseTest {
    ...
    void findDigitInNumberCount() {
        assertThrows(IllegalArgumentException.class,() -> Exercise.findDigitInNumberCount(-1,12357324));
        assertThrows(IllegalArgumentException.class,() -> Exercise.findDigitInNumberCount(36578945,-1));
